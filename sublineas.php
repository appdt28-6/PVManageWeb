            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Lineas
                            <small>Información de Sublineas principales</small>
                        </h1>
                         ...
                         <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Sub lineas
                            </li>
                        </ol>
                        
                        <div class="row">
				<p>
					<a href="createsubline.php" class="btn btn-success">Nuevo</a>
				</p>
				...
				<table class="table table-striped table-bordered">
		              ...
		              <?php 
					   ...
					   $sql = 'SELECT sublineas.idSublinea as sub,lineas.descripcion as linea, sublineas.descripcion as descr FROM sublineas inner join lineas on sublineas.idLinea=lineas.idLinea';
	 				   foreach ($pdo->query($sql) as $row) {
								...
								echo '<td>'. $row['descr'] . '</td>';
							   	...
							   	echo '<a class="btn btn-success" href="updatesublineas.php?id='.$row['sub'].'">Editar</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-danger" href="deletesublineas.php?id='.$row['sub'].'">Eliminar</a>';
							   	echo '</td>';
							   	echo '</tr>';
					   }
					   Database::disconnect();
