                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Lineas
                            <small>Información de lineas principales</small>
                        </h1>
                         ...
                         <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i>Lineas
                            </li>
                        </ol>
                        
                        <div class="row">
				<p>
					<a href="createlinea.php" class="btn btn-success">Nuevo</a>
				</p>
		              ...
		              <?php 
					   ...
					   $sql = 'SELECT * FROM lineas';
	 				   foreach ($pdo->query($sql) as $row) {
						   		echo '<tr>';
							   	echo '<td>'. $row['idLinea'] . '</td>';
								echo '<td>'. $row['descripcion'] . '</td>';
							   	echo '<td width=250>';
							   	
							   	echo '<a class="btn btn-success" href="updatelinea.php?id='.$row['idLinea'].'">Editar</a>';
							   	echo '&nbsp;';
							   	echo '<a class="btn btn-danger" href="deletelinea.php?id='.$row['idLinea'].'">Eliminar</a>';
							   	echo '</td>';
							   	echo '</tr>';
					   }
					   Database::disconnect();
